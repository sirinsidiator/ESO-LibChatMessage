...
ReplaceBuiltInFormatter(EVENT_CHAT_MESSAGE_CHANNEL, internal.class.ChatMessageFormatter:New())

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_BROADCAST, "test")
ReplaceBuiltInFormatter(EVENT_BROADCAST, internal.class.TaggedMessageFormatter:New(SYSTEM_TAG))
...
ReplaceBuiltInFormatter(EVENT_FRIEND_PLAYER_STATUS_CHANGED, internal.class.PlayerStatusFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_IGNORE_ADDED, "test")
ReplaceBuiltInFormatter(EVENT_IGNORE_ADDED, internal.class.IgnoreStatusFormatter:New(SYSTEM_TAG, SI_FRIENDS_LIST_IGNORE_ADDED))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_IGNORE_REMOVED, "test")
ReplaceBuiltInFormatter(EVENT_IGNORE_REMOVED, internal.class.IgnoreStatusFormatter:New(SYSTEM_TAG, SI_FRIENDS_LIST_IGNORE_REMOVED))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_GROUP_TYPE_CHANGED, false)
ReplaceBuiltInFormatter(EVENT_GROUP_TYPE_CHANGED, internal.class.GroupTypeFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_GROUP_INVITE_RESPONSE, "test", GROUP_INVITE_RESPONSE_PLAYER_NOT_FOUND, "test")
ReplaceBuiltInFormatter(EVENT_GROUP_INVITE_RESPONSE, internal.class.GroupInviteFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_SOCIAL_ERROR, SOCIAL_RESULT_ACCOUNT_NOT_FOUND)
ReplaceBuiltInFormatter(EVENT_SOCIAL_ERROR, internal.class.SocialErrorFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_TRIAL_FEATURE_RESTRICTED, TRIAL_RESTRICTION_CANNOT_WHISPER)
ReplaceBuiltInFormatter(EVENT_TRIAL_FEATURE_RESTRICTED, internal.class.TrialRestrictionFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_GROUP_MEMBER_LEFT, "character", GROUP_LEAVE_REASON_KICKED, true, false, "account", true)
ReplaceBuiltInFormatter(EVENT_GROUP_MEMBER_LEFT, internal.class.GroupKickFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:FormatAndAddChatMessage(EVENT_BATTLEGROUND_INACTIVITY_WARNING)
ReplaceBuiltInFormatter(EVENT_BATTLEGROUND_INACTIVITY_WARNING, internal.class.BattlegroundInactivityFormatter:New(SYSTEM_TAG))

-- CHAT_ROUTER:AddSystemMessage("test")
ReplaceBuiltInFormatter("AddSystemMessage", internal.class.TaggedMessageFormatter:New(SYSTEM_TAG))
...
do
    ...
    local formatter = internal.class.ChatProxyFormatter:New()
